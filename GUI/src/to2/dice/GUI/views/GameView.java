...
public class GameView extends View {
	...
	public GameView(Model model, GameController controller, GameAnimation gameAnimation) {
		...
		playerTable = new JTable(new AbstractTableModel() {
			private final String[] columnNames = { "Gracz", "Koœci", "Punkty" };
		...
		if (model.getGameState().getCurrentPlayer() != null
				&& model.getGameState().getCurrentPlayer().getName().equals(model.getLogin())) {
